...
/**
 * Provides the local service interface for UserPersonalizedTheme. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samir Bhatt
 * @see UserPersonalizedThemeLocalServiceUtil
...
public interface UserPersonalizedThemeLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link UserPersonalizedThemeLocalServiceUtil} to access the user personalized theme local service. Add custom service methods to {@link com.knowarth.portlets.themepersonalizer.service.impl.UserPersonalizedThemeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
