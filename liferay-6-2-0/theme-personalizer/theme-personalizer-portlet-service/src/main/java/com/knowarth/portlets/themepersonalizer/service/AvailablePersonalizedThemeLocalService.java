...
/**
 * Provides the local service interface for AvailablePersonalizedTheme. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samir Bhatt
 * @see AvailablePersonalizedThemeLocalServiceUtil
...
public interface AvailablePersonalizedThemeLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AvailablePersonalizedThemeLocalServiceUtil} to access the available personalized theme local service. Add custom service methods to {@link com.knowarth.portlets.themepersonalizer.service.impl.AvailablePersonalizedThemeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
