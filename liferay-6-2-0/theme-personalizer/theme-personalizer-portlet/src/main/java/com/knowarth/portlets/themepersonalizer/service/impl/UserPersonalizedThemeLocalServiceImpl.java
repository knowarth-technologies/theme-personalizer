 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.knowarth.portlets.themepersonalizer.service.UserPersonalizedThemeLocalService} interface.
 *
 * <p>
 ...
 */
public class UserPersonalizedThemeLocalServiceImpl
    extends UserPersonalizedThemeLocalServiceBaseImpl {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never reference this interface directly. Always use {@link com.knowarth.portlets.themepersonalizer.service.UserPersonalizedThemeLocalServiceUtil} to access the user personalized theme local service.
     */
	public UserPersonalizedTheme addUserPersonalizedTheme(long userId,
		...
		userPersonalizedThemePersistence.update(userPersonalizedTheme);
