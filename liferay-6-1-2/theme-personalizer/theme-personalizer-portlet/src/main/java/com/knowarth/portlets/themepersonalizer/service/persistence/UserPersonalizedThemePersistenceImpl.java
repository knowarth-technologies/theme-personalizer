...
public class UserPersonalizedThemePersistenceImpl extends BasePersistenceImpl<UserPersonalizedTheme>
    ...
    protected UserPersonalizedTheme removeImpl(
        ...
        try {
            ...
            BatchSessionUtil.delete(session, userPersonalizedTheme);
        } catch (Exception e) {
            throw processException(e);
        } finally {
            closeSession(session);
    ...
    public UserPersonalizedTheme updateImpl(
        ...
        try {
            ...
            BatchSessionUtil.update(session, userPersonalizedTheme, merge);
        ...
        if (isNew || !UserPersonalizedThemeModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((userPersonalizedThemeModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        Long.valueOf(userPersonalizedThemeModelImpl.getOriginalUserId()),
                        Boolean.valueOf(userPersonalizedThemeModelImpl.getOriginalApplyForAllPages())
                    };
                ...
                args = new Object[] {
                        Long.valueOf(userPersonalizedThemeModelImpl.getUserId()),
                        Boolean.valueOf(userPersonalizedThemeModelImpl.getApplyForAllPages())
                    };
            ...
            if ((userPersonalizedThemeModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        Long.valueOf(userPersonalizedThemeModelImpl.getOriginalUserId()),
                        Long.valueOf(userPersonalizedThemeModelImpl.getOriginalLayoutId())
                    };
                ...
                args = new Object[] {
                        Long.valueOf(userPersonalizedThemeModelImpl.getUserId()),
                        Long.valueOf(userPersonalizedThemeModelImpl.getLayoutId())
                    };
     ...
     * @throws com.liferay.portal.NoSuchModelException if a user personalized theme with the primary key could not be found
     * @throws SystemException if a system exception occurred
     */
    @Override
    ...
    public UserPersonalizedTheme findByPrimaryKey(long id)
        throws NoSuchUserPersonalizedThemeException, SystemException {
        UserPersonalizedTheme userPersonalizedTheme = fetchByPrimaryKey(id);
    ...
    public UserPersonalizedTheme fetchByPrimaryKey(long id)
        ...
        UserPersonalizedTheme userPersonalizedTheme = (UserPersonalizedTheme) EntityCacheUtil.getResult(UserPersonalizedThemeModelImpl.ENTITY_CACHE_ENABLED,
                UserPersonalizedThemeImpl.class, id);
    ...
    public void removeByUserId(long userId) throws SystemException {
        for (UserPersonalizedTheme userPersonalizedTheme : findByUserId(userId)) {
            remove(userPersonalizedTheme);
        }
    }
    ...
    public int countByUserIdAndApplyForAllPages(long userId,
        ...
        Long count = (Long) FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_USERIDANDAPPLYFORALLPAGES,
                finderArgs, this);
        ...
        if (count == null) {
            ...
            try {
                ...
                FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_USERIDANDAPPLYFORALLPAGES,
                    finderArgs, count);
    ...
    public int countByUserIdAndLayoutId(long userId, long layoutId)
        ...
        Long count = (Long) FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_USERIDANDLAYOUTID,
                finderArgs, this);
        ...
        if (count == null) {
            ...
            try {
                ...
                FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_USERIDANDLAYOUTID,
                    finderArgs, count);
    ...
    public int countByThemeId(String themeId) throws SystemException {
        ...
        Long count = (Long) FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_THEMEID,
                finderArgs, this);
        ...
        if (count == null) {
            ...
            try {
                ...
                FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_THEMEID,
                    finderArgs, count);
