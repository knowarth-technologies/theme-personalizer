...
public class AvailablePersonalizedThemeLocalServiceClp
    ...
    public AvailablePersonalizedThemeLocalServiceClp(
        ...
        _methodName9 = "fetchAvailablePersonalizedTheme";

        _methodParameterTypes9 = new String[] { "long" };

        _methodName10 = "getAvailablePersonalizedTheme";
        ...
        _methodName12 = "getAvailablePersonalizedThemes";

        _methodParameterTypes12 = new String[] { "int", "int" };

        _methodName13 = "getAvailablePersonalizedThemesCount";

        _methodParameterTypes13 = new String[] {  };

        _methodName14 = "updateAvailablePersonalizedTheme";
        ...
        _methodName19 = "addAvailablePersonalizedTheme";

        _methodParameterTypes19 = new String[] { "long", "java.lang.String" };

        _methodName20 = "removeAllByCompanyId";

        _methodParameterTypes20 = new String[] { "long" };

        _methodName21 = "findAllByCompanyId";
    ...
    public com.knowarth.portlets.themepersonalizer.model.AvailablePersonalizedTheme addAvailablePersonalizedTheme(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(availablePersonalizedTheme)
                    });
        } catch (Throwable t) {
        ...
        return (com.knowarth.portlets.themepersonalizer.model.AvailablePersonalizedTheme) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.knowarth.portlets.themepersonalizer.model.AvailablePersonalizedTheme> getAvailablePersonalizedThemes(
        ...
        return (java.util.List<com.knowarth.portlets.themepersonalizer.model.AvailablePersonalizedTheme>) ClpSerializer.translateOutput(returnObj);
    }
